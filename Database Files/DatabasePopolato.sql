...
-- Started on 2023-12-06 17:45:37
...
--
-- TOC entry 4949 (class 0 OID 16624)
-- Dependencies: 222
...
--
-- TOC entry 4943 (class 0 OID 16554)
-- Dependencies: 216
-- Data for Name: user; Type: TABLE DATA; Schema: photogallery; Owner: postgres
--

COPY photogallery."user" (nickname, name, surname, birthdate, gender) FROM stdin;
FastWing	Silvia	Barbieri	2002-02-01	F
Chrls16	Marco	Ferrari	1999-01-11	M
Deleted User	 	 	\N	\N
Table13	Giorgio	Casa	2000-03-20	M
Franco01	Franco	Zeruno	1980-04-01	M
Pippo	Filippo	Zeruno	1982-09-05	M
Butterfly99	Valeria	Esposito	2002-12-10	F
\.


--
-- TOC entry 4952 (class 0 OID 16678)
-- Dependencies: 225
...
--
-- TOC entry 4948 (class 0 OID 16608)
-- Dependencies: 221
...
--
-- TOC entry 4955 (class 0 OID 16812)
-- Dependencies: 228
...
--
-- TOC entry 4945 (class 0 OID 16587)
-- Dependencies: 218
...
--
-- TOC entry 4946 (class 0 OID 16592)
-- Dependencies: 219
...
--
-- TOC entry 4956 (class 0 OID 17093)
-- Dependencies: 229
...
--
-- TOC entry 4957 (class 0 OID 17098)
-- Dependencies: 230
...
--
-- TOC entry 4950 (class 0 OID 16645)
-- Dependencies: 223
...
--
-- TOC entry 4944 (class 0 OID 16572)
-- Dependencies: 217
...
-- Completed on 2023-12-06 17:45:37
